...
class _LudoGameBoardPageState extends State<LudoGameBoardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Container(height: 350, width: 350, margin: EdgeInsets.all(20), color: Colors.white, child: Stack(children: [Positioned(left: coinPosition, child: Icon(Icons.circle, color: Colors.red, size: 30))])),
